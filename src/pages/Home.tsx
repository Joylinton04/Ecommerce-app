      ...
      <div className="mt-20 px-14 py-4 max-w-[1440px] mx-auto ssm:px-7">
        ...
        <div className="flex flex-col gap-20 mt-10">
          <div className="flex gap-4">
            <img src={assets.fqa1} className="w-[251px]" />
            <div className="flex flex-col gap-4 justify-between">
              ...
              <h1 className="font-bold text-xl">Mariana Van Zeeler</h1>
            </div>
          </div>
          <div className="flex gap-4">
            <img src={assets.fqa2} className="w-[251px]" />
            <div className="flex flex-col gap-4 justify-between">
              <p className="text-xl">
                Fast shipping and great packaging! My order arrived in perfect
                condition.
          ...
          <div className="flex gap-4">
            <img src={assets.fqa3} className="w-[251px]" />
            <div className="flex flex-col gap-4 justify-between">
              <p className="text-xl">
                Fast shipping and great packaging! My order arrived in perfect
                condition.
