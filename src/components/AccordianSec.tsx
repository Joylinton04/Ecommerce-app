    ...
    <div className="w-1/2 flex flex-col justify-between mdd:gap-6 ssm:w-full">
      {accordion.map((info, index) => (
        ...
        >
          ...
          >
            <AccordionTrigger className="text-start w-full font-semibold text-lg text-[#2F2F2F] hover:underline focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-black mdd:text-sm">
              {info.text}
            </AccordionTrigger>
